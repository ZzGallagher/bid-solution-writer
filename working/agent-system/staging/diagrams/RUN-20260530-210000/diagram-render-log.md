...
- Generated At: `2026-05-30T21:52:52+08:00`
...
|---|---|---|---|---|
| DG001 | fallback_rendered | true | `working/agent-system/render-validate-example-output-2/diagrams/DG001.png` | render_status=fallback_rendered：原生 Mermaid 渲染不可用或失败，已生成降级 PNG，需人工关注。; 未找到 Mermaid CLI 渲染器，已生成降级 PNG。 |
